...
/**
 * Hierarchical bubble data example
 * Demonstrates nested circle packing
 */
export const FALLBACK_BUBBLE_DATA_HIERARCHICAL: BubbleItem[] = [
	{
		id: 'tech',
		label: 'Technology',
		value: 0,
		...
		children: [
			{
				...
				children: [
					{ id: 'aws', label: 'AWS', value: 80, group: 'Cloud' },
					{ id: 'azure', label: 'Azure', value: 65, group: 'Cloud' },
					{ id: 'gcp', label: 'GCP', value: 35, group: 'Cloud' }
				]
			},
			{
				id: 'ai',
				...
				children: [
					{ id: 'openai', label: 'OpenAI', value: 29, group: 'AI' },
					{ id: 'nvidia', label: 'NVIDIA', value: 45, group: 'AI' },
					{ id: 'anthropic', label: 'Anthropic', value: 10, group: 'AI' }
				]
			},
			{
				...
				group: 'Social',
				children: [
					{ id: 'facebook', label: 'Meta', value: 115, group: 'Social' },
					{ id: 'youtube', label: 'YouTube', value: 30, group: 'Social' },
					{ id: 'tiktok', label: 'TikTok', value: 25, group: 'Social' }
				]
			}

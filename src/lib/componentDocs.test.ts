...
const GOLD_STANDARD_DOCS = [
	...
	'src/lib/components/ShapeTrail/ShapeTrailHero.md',
	'src/lib/components/LiquidType/LiquidTypeHero.md',
	'src/lib/components/DragGallery/DragGallery.md',
	'src/lib/components/MomentumSlider/MomentumSlider.md',
	'src/lib/components/Picasso/PicassoPortfolio.md',
	'src/lib/components/GsapTimeline.md',
	'src/lib/components/GsapGantt.md',

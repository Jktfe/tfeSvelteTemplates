...
<style>
	...
	/*
	 * ============================================================
	 * DESIGN NOTES — optimisations deliberately left out
	 * ============================================================
	 *
	 * Lazy loading images - INTENTIONALLY NOT DONE
	 ...
	 *
	 * Virtual scrolling/DOM recycling - INTENTIONALLY NOT DONE
	 ...
	 *
	 * prefers-reduced-motion - OPTIONAL/USEFUL (complex)
	 ...
	 * require JavaScript changes (not just CSS) to disable inertia, and the
	 * component may not make sense without its core interaction model.
	 *

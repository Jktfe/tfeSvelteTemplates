	...
	{#snippet demo()}
		<div class="sc-demo">
			<div class="sc-card sc-card--centered">
				<h3 class="sc-headline">
					We
					<ScrambledText text="ENGINEER" duration={2200} class="sc-accent" />
			...
			<div class="sc-card sc-card--centered sc-staged">
				...
				<span class="sc-display-2"><ScrambledText text="Set." duration={900} delay={500} /></span>
				<span class="sc-display-2"><ScrambledText text="Go." duration={900} delay={1000} /></span>
			</div>

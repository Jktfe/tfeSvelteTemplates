...
VALUES
    ...
    ('build-frontend', 'Build front-end',      CURRENT_DATE + 5, CURRENT_DATE + 16, 25,  FALSE, NULL,     'Build', 'Child-1',  3),
    ('build-api',      'Build API',            CURRENT_DATE + 2, CURRENT_DATE + 12, 40,  FALSE, NULL,     'Build', 'Child-2',     4),
